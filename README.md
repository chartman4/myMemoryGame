...
It used the base code of the react Memory Game from Udemy Course Advanced Web Developmer Bootcamp but adds a component for keeping track of the number of tries and uses pictures from the internet instead of colors (though the colors are kept to compare)
